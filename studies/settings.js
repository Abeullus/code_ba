...
Zudem wird hier noch die reale Zeit des jeweiligen Studiendurchlaufs, sowie die Task-Error-Rate und die Task-Success Rate berechnet.
...
var clicks = [];
var animationDuration = 200; // Dauer der Animation = W(t)
...
/* Der Nachfolgende Block ist für das Zählen der Fehler, das Aufzeichnen der einzelnen Clicks und das Anzeigen der zu suchenden Wörter und des Timers zuständig */
$('nav span, nav label').click(function() {
    if ($(this).next('ul').length) {
        ...
        if ($(this).children('input')[0].checked) {
            currentWord++;
            $('nav ul').removeClass('open').stop().fadeOut(animationDuration); 
